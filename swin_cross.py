...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, window_size2, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
...
class ContextAwareTransformer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=8, window_size2 = 8, shift_size=0,
        ...
        self.attn = WindowAttention(
            dim, window_size=to_2tuple(self.window_size), window_size2=to_2tuple(self.window_size2),num_heads=num_heads,
