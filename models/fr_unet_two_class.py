...
class FR_UNet_2class(nn.Module):
    def __init__(self,  num_classes=2, num_channels=1, feature_scale=2,  dropout=0.2, fuse=True, out_ave=True):
        super(FR_UNet_2class, self).__init__()
