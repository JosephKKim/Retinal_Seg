...
from swin_cross import HDRTransformer
...
class FR_UNet_Cross(nn.Module):
    def __init__(self,  num_classes=1, num_channels=1, feature_scale=2,  dropout=0.2, fuse=True, out_ave=True):
        ...
        # for 
        # self.upchConv = nn.Conv2d(64, 128, kernel_size=1) 
    ...
    def forward(self, x):
        ...
        # x1_2하고 x_down1_2하고
        # x_down1_2 = self.swin_cross_24_64(x_down1_2, x1_2)
        
        # 11
        # x1_2 x2_2
        x2_2 = self.swin_cross_24_64(x2_2, x1_2)
        ...
        # 13
        # x20 = self.swin_cross_24_64(x20, x10)
        
        # 23
        # x_down20 = self.swin_cross_12_128(x_down20, x20)
        ...
        # 14
        # x21 = self.swin_cross_24_64(x21, x11)
